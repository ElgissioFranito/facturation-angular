...
@Component({
  ...
  standalone: true,
  imports: [
    CardComponent, CardHeaderComponent, CardTitleComponent, CardContentComponent, LucideAngularModule, CurrencyPipe],
  template: `
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <app-card>
        ...
        <app-card-content>
          <div class="text-2xl font-bold">{{ metrics.totalMonth | currency:currencyCode():'symbol':'1.0-0' }}</div>
      ...
      <app-card>
        <app-card-header class="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <lucide-icon name="circle-check" class="h-4 w-4 text-secondary"></lucide-icon>
        </app-card-header>
        <app-card-content>
      ...
      <app-card>
        <app-card-header class="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <lucide-icon name="circle-alert" class="h-4 w-4 text-destructive"></lucide-icon>
        </app-card-header>
        <app-card-content>
